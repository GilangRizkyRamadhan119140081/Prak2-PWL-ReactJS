         ...
         <div className="row">
            <div className="eight columns">
               ...
               <form id="contactForm" name="contactForm">
                  ...
                  <div>
						   <label htmlFor="contactName">Nama <span className="required">*</span></label>
                  ...
                  <div>
                     <label htmlFor="contactMessage">Pesan <span className="required">*</span></label>
           ...
           <div id="message-warning"> Error boy</div>
                  ...
                  <i className="fa fa-check"></i>Pesan kamu terkirim, Terimakasih!<br />
				   </div>
           </div>
            ...
            <aside className="four columns footer-widgets">
               <div className="widget widget_contact">
					   ...
					   <h4>Alamat dan Telepon</h4>
					   <p className="address">
						   Gilang Rizky Ramadhan<br />
						   jl. Kelinci Street<br />
						   {data?.address.city}, {data?.address.state} {data?.address.zip}<br />
						   <span>0822653387633</span>
					   </p>
				   </div>
